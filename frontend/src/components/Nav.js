        ...
        <nav className="bg-gray-800">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                ...
                                <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Basket</a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="sm:hidden" id="mobile-menu">
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Basket</a>
                </div>
            </div>
        </nav>
    )
